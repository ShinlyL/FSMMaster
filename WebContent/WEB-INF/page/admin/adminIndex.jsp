...
<body>
	<section id="container">
		...
		<header class="header black-bg">
			...
			<!--logo start-->
			<a href="index.html" class="logo"><b><span>企业</span>申领系统-管理端</b></a>
			<!--logo end-->
			<ul class="logo">
				...
				<i class="fa fa-user fa-lg headslxt">${adminInfo.username }</i></a>
          		<ul class="dropdown-menu settings-menu dropdown-menu-right headslxtdropdown">
            		<li><a class="dropdown-item" href="javascript:changeMenu('adminInfo.udo');"><i class="fa fa-user fa-lg"></i> 个人信息</a></li>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					<h5 class="centered">欢迎您，${adminInfo.username }</h5>
					<li class="mt"><a class="active" href="indexServlet"> <i
							class="fa fa-dashboard"></i> <span>首页</span>
					</a></li>
					<li class="sub-menu"><a href="#"> <i
							class="fa fa-cogs"></i> <span>人员管理</span>
					</a>
						<ul class="sub">
							<li><a href="javascript:changeMenu('userList.udo');">查看用户</a></li>
							<li><a href="javascript:changeMenu('toAddUser.udo');">添加用户</a></li>
						</ul></li>
					<li class="sub-menu"><a
						href="javascript:changeMenu('goodsList.gdo');"> <i
							class="fa fa-th"></i> <span>物品管理</span>
					</a></li>
					<li class="sub-menu">
						<a href="javascript:changeMenu('inventoryList.do');">
						 	<i class="fa fa-book"></i> <span>库存管理</span>
						</a>
					</li>
					<li class="sub-menu">
						<a href="javascript:changeMenu('insideList.ido');">
							<i class="fa fa-tasks"></i> <span>入库管理</span>
						</a>
					</li>
					<li class="sub-menu">
						<a href="javascript:;"> 
							<i class="fa fa-tasks"></i> <span>审核申领管理</span>
						</a>
						<ul class="sub">
							<li><a href="javascript:changeMenu('applyList.ado?id=1');">已审核管理</a></li>
							<li><a href="javascript:changeMenu('applyList.ado?id=0');">待审核管理</a></li>
							<li><a href="javascript:changeMenu('applyList.ado?id=2');">未通过管理</a></li>
						</ul>
					</li>
				</ul>
			</div>
					...
					<div class="modal-body">
						...
						<div class="col-md-8">
							<input name="username" id="username" class="form-control"
								value=${adminInfo.username } type="text" readonly="readonly">
						</div>
    ...
    function changepw(){
		...
		function updatepw(){
			...
			var oldpw = $("#oldpw").val();
			var newpw = $("#newpw").val();
			if(oldpw == null || oldpw != '${adminInfo.password}'){
				alert("原密码输入有误");
				//鼠标聚焦到指定的输入框中
				$("#oldpw").focus();
				return false;
